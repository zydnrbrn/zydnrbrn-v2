            ...
            <div className="container px-4 lg:ml-8">
                <div className="mx-auto block gap-2 sm:flex text-center">
                    ...
                    <div className="img-header sm:float-right sm:relative">
                        <Image className="h-[380] w-[400px] md:h-[486px] md:w-full sm:mt-[100px] justify-center lg:float-right" src="https://ik.imagekit.io/3upgjbxqx/protofolio-source/undraw_Code_thinking_re_gka2.png?updatedAt=1680577426555"
                             alt={'Intro Image'}/>
                    </div>
                </div>
                <div className="gap-2 mt-10 sm:flex" id="about">
                    <div className="img-header mt-[60px]">
                        <Image className="h-[380] w-[400px] md:h-[486px] md:w-full justify-center" src="https://ik.imagekit.io/3upgjbxqx/protofolio-source/undraw_Hacker_mindset_re_8a33.png?updatedAt=1680577426527"
                             alt="Intro image"  />
                    </div>
